...
Not: §2.2'deki `focusto` gezintisinin adresi 17.09.2026'da entry'nin okunduğu sayfa adresi (`?p=N#eksi-stories-<entry id>`) oldu, çünkü `focusto` yeni entry'lerde sayfayı bulamıyor (2026-09-16-sayfa-gostergesi-design.md §7). Zamanlama ve §2.2'deki değerlendirme aynen geçerli.
